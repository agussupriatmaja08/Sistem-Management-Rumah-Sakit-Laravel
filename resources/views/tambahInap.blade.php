...
@section('content')
    ...
    <center>
        ...
        <form action="/tambahInap" method="GET">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <table>
                         ...
                         <a href="/formInap/{{ $pasien['id'] }}"><button class="btn bg-primary text-light"> Carikan Ruangan </button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        @endif
        <a href="/inap"><button class="btn btn-danger">Kembali</button></a> 
